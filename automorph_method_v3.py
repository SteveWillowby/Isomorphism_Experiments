...
class GGraph:
    ...
    def __init__(self, G, external_labels=None, was_from_complement=False):
        ...
        if self.num_components > 1:
            ...
            for component in components:
                ...
                component_graph = GGraph(self.G.subgraph(component), node_labels) # TODO: Be sure I don't need to pass on self.complement
    ...
    def get_new_sorted_neighborhoods(self):
        ...
        for node in self.nodes:
            ...
            graph = GGraph(self.neighborhood_subgraphs[node], starting_neighbor_labels, self.neighborhood_complements[node])
